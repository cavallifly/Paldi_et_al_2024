...
phi=0.10
prevDir=01_compression_to_mESC_rosette_phi_${phi}LV_resolution_${resolution}bp_${ncopies}_copies
...
do
    ...
    n=$((${n}+1))
    mpirun -np 8 python ${pyfile%.py}_${replica}.py &>> replica_${replica}.out
