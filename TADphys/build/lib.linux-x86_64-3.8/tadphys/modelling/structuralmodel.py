...
from tadphys.utils.tadmaths        import newton_raphson
from tadphys                       import __version__ as version
...
class StructuralModel(dict):
    ...
    #                model (:func:`tadphys.utils.extraviews.color_residues`)
    #              * '**tad**' to color particles according to the TAD they belong to
    #                (:func:`tadphys.utils.extraviews.tad_coloring`)
    #              * '**border**' to color particles marking borders. Color according to
    #                their score (:func:`tadphys.utils.extraviews.tad_border_coloring`)
...
#             return None
    ...
    #     :param kwargs: see :func:`tadphys.utils.extraviews.plot_3d_model` or
    #        :func:`tadphys.utils.extraviews.chimera_view` for other arguments
